...
class SolutionGraspTests(unittest.TestCase):
    GRAPH_TEST = 'test_files/setsFinal/set-e/DIMACS2/johnson8-2-4.txt'
    ...
    def test_verify_clique(self):
        SET_D = "test_files/setsFinal/set-d/wind-2004.txt"
        SET_F = "test_files/setsFinal/set-f/DIMACS10/email.txt"
        clique = {94, 66, 278, 14}
        graph = Instance()
        file = SET_D
        graph.read_file(file)
